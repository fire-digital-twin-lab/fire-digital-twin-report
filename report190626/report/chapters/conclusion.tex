...
Nghiên cứu này là một prototype thử nghiệm học thuật và tồn tại một số giới hạn cốt lõi: hoàn toàn sử dụng dữ liệu mô phỏng cháy (CFAST làm nguồn sinh dữ liệu chính, FDS kiểm chứng chọn lọc) mà chưa có thực nghiệm thực tế; hệ thống cảm biến IoT được giả lập bằng phần mềm; mô hình AI đóng vai trò là mô hình thay thế (surrogate model) tính toán nhanh và chưa tích hợp pháp lý cho các ngưỡng nguy hiểm. Chi tiết về các giả định và giới hạn nghiên cứu được trình bày cụ thể tại Chương~\ref{chap:assumptions}.
